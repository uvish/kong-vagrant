...
echo "*************************************************************************"
 ...
 #sudo -E add-apt-repository "deb https://apt.postgresql.org/pub/repos/apt/ bionic-pgdg main"
  wget --quiet -O --no-check-certificate - https://www.postgresql.org/media/keys/ACCC4CF8.asc | sudo apt-key add -
 ...
 wget -q -O --no-check-certificate - https://www.apache.org/dist/cassandra/KEYS | sudo apt-key add -
